...
function [t, g] = ConvertToStimControlParameters(p, g)
    %todo
    disp("todo")
    t = struct( ...
        'tPre', 0, ...
    ...
    stimuli = struct(...
        'QST', struct( ...
            ...
            'thermodeA', thermodeStruct, ...
            'thermodeB', thermodeStruct), ...
        'LED', struct( ...
            'identifier', 'LED', ....
            'type', 'PWM', ...
            'isAcquisitionTrigger', false, ...
        ...
        'camera', struct( ...
            'identifier', 'camera', ....
            'type', 'serial', ...
            'isAcquisitionTrigger', true)); %target a type of hardware or a specific instance of the hardware
    % stimuli = repmat(stimuli, [1, length(p)]);
