...
%% Make UI menu
% obj.h.Menu.File = uimenu(obj.h.fig, ...
%     "Text", "File");
% obj.h.Menu.Load = uimenu(obj.h.Menu.File, ...
%     "Text", "Load");
% obj.h.Menu.Load.ComponentConfig = uimenu(obj.h.Menu.Load, ...
%     'Text', 'Component config', ...
%     'MenuSelectedFcn', @obj.callbackLoadComponentParams);
% obj.h.Menu.Load.Protocol = uimenu(obj.h.Menu.Load, ...
%     'Text', 'Experiment protocol', ...
%     'MenuSelectedFcn', @obj.callbackLoadSessionProtocol);
% obj.h.Menu.Load.StimControlSession = uimenu(obj.h.Menu.Load, ...
%     'Text', 'StimControl session', ...
%     'MenuSelectedFcn', @obj.callbackLoadAppSession);
% obj.h.Menu.Save = uimenu(obj.h.Menu.File, ...
%     "Text", "Save");
% obj.h.Menu.Save.ComponentConfig = uimenu(obj.h.Menu.Save, ...
%     'Text', 'Component config', ...
%     'MenuSelectedFcn', @obj.callbackSaveComponentParams);
% obj.h.Menu.SaveProtocol = uimenu(obj.h.Menu.Load, ...
%     'Text', 'Experiment protocol', ...
%     'MenuSelectedFcn', @obj.callbackLoadSessionProtocol);
% obj.h.Menu.SaveStimControlSession = uimenu(obj.h.Menu.Save, ...
%     'Text', 'StimControl session', ...
%     'MenuSelectedFcn', @obj.callbackSaveAppSession);
% 
...
obj.h.Setup.Logo = uiimage(obj.h.Setup.Grid, ...
    "ImageSource", "icons/WhitmireLogo.png", ...
    "ScaleMethod", "fit", ...
    "Layout", matlab.ui.layout.GridLayoutOptions( ...
        'Row',3, ...
        'Column',2));
...
obj.h.Session.Control.panel.params = uipanel(obj.h.Session.Grid, ...
    ...
    'Layout', matlab.ui.layout.GridLayoutOptions( ...
        'Row', 2, ...
        'Column', 2));
obj.h.Session.Info.panel.params = uipanel(obj.h.Session.Grid, ...
    'CreateFcn', @obj.createPanelSessionInfo, ...
    'Title', 'Session Info', ...
    'Layout', matlab.ui.layout.GridLayoutOptions( ...
        'Row', 1, ...
        'Column', 2));
obj.h.Session.Hardware.panel.params = uipanel(obj.h.Session.Grid, ...
